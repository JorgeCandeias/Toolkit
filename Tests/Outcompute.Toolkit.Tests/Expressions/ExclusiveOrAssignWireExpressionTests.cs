...
public class ExclusiveOrAssignWireExpressionTests
{
    [Fact]
    public void ToStringEmitsText()
    {
        ...
        var expression = new ExclusiveOrAssignWireExpression(left, right);
    ...
    public void FactoryCreatesExpression()
    {
        ...
        Assert.IsType<ExclusiveOrAssignWireExpression>(result);
